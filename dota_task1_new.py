...
datamap2 = {'0A': 'plane', '0B': 'fighter aeroplane', '0C': 'radar',
           ...
           '16': 'helicopter', '17': 'airport', '18A': 'viaduct'}
def main():
    detpath = r'/home/dingjian/evaluation_task1/faster-rcnn-rot-59-Task1/Task1_{:s}.txt'
    #annopath = r'G:\voc_eval\GFformatPascal\{:s}.txt'
    annopath = r'/home/dingjian/evaluation_task1/Task1_gt/{:s}.txt'
    #annopath = r'E:\bod-dataset\testset\ReclabelTxt\{:s}.txt'
    imagesetfile = r'/home/dingjian/evaluation_task1/testset.txt'
    classnames = ['plane', 'baseball-diamond', 'bridge', 'ground-track-field', 'small-vehicle', 'large-vehicle', 'ship', 'tennis-court',
                'basketball-court', 'storage-tank',  'soccer-ball-field', 'roundabout', 'harbor', 'swimming-pool', 'helicopter']
    #classnames = ['small-vehicle']
    # classnames = ['tennis-court']
    classaps = []
    map = 0
