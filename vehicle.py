...
datamap2 = {'0A': 'plane', '0B': 'fighter aeroplane', '0C': 'radar',
           ...
           '16': 'helicopter', '17': 'airport', '18A': 'viaduct'}
def main():
    detpath = r'E:\downloaddataset\3K_VehicleDetection_dataset\results\bod-valid-vehicle\comp4-nms\comp4_det_test_{:s}.txt'
    #annopath = r'G:\voc_eval\GFformatPascal\{:s}.txt'
    annopath = r'E:\downloaddataset\3K_VehicleDetection_dataset\Test_bod\ReclabelTxt\{:s}.txt'
    imagesetfile = r'E:\downloaddataset\3K_VehicleDetection_dataset\Test_bod\testset.txt'
