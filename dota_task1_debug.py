...
def voc_eval(detpath,
    ...
    for d in range(nd):
        ## for debug
        with codecs.open(os.path.join(r'I:\dota\testset\fordebug\Taskformat_was', image_ids[d] + '.txt'), 'a', 'utf_16') as f_out:
            ...
            if ovmax > ovthresh:
                if not R['difficult'][jmax]:
                    if not R['det'][jmax]:
                        ...
                        fp[d] = 1.
                        print('filename:', image_ids[d])  ##TODO: print wrong fp and gt
                        outline = ' '.join(map(str, bb)) + ' ' + 'large-vehicle' + ' ' + '0'
                        f_out.write(outline + '\n')
            else:
                fp[d] = 1.
...
datamap2 = {'0A': 'plane', '0B': 'fighter aeroplane', '0C': 'radar',
           ...
           '16': 'helicopter', '17': 'airport', '18A': 'viaduct'}
def main():
    detpath = r'I:\dota\testset\fordebug\Taskformat_gt\Task1_{:s}.txt'
    #annopath = r'G:\voc_eval\GFformatPascal\{:s}.txt'
    annopath = r'I:\dota\testset\fordebug\dotalabel\{:s}.txt'
    #annopath = r'E:\bod-dataset\testset\ReclabelTxt\{:s}.txt'
    imagesetfile = r'I:\dota\testset\fordebug\debugset.txt'
